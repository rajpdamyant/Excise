...
<form id="form" name="form">
    <table>
        ...
        <tr>
            <td>
                Account Head :&nbsp&nbsp   ${accountHeadId}
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            </td>
        </tr>
        <tr>
            <td colspan="4">
                <div id="accountHead">
                    <div id="accountHead1">
                        ...
                        &nbsp&nbsp Treasury Challan Id:<input type="text" name="accountHeadTreasureId1"
                        ...
                        &nbsp   Establishment Name :<input type="text" size="32" name="accountHeadConsumerName1"
                                                           readonly="true" id="accountHeadConsumerName1" size="6">
                    ...
                    Amount in Words (Rs.):<input type="text" name="accountHeadAmountInWords1"
                                                           id="accountHeadAmountInWords1" value=""
                                                           size="65" readonly="true">
                        Duration:<select id="accountHeadduration">
        ...
        <tr>
            <td colspan="4">
                ...
                <input type="Cancel" value="Cancel" onclick="reset1()" class="${classs} buttonCss"/>
            </td>
        </tr>
            <tr><td colspan="4">
...
<script type="text/javascript">
        ...
        $('#accountHead div').each(function () {
            if (returnResult) {
                $(this).children('[id^="accountHead"]').each(function () {
                    ...
                    else if (name == "DistrictOfficeList") {
                        if ($(this).val() == "Choose A District") {
    ...
    function submitForm1() {
        ...
        if (Id == '') {
         ...
         else if ($('#accountHeadduration').val() == 'Choose A Duration') {
...
//        }
        ...
        else if ($('#accountHeadConsumerName1').val() == ' ') {
...
//            alert("inside check");
            ...
            var flag = 0;
            var accountHeadId =${accountHeadId};
            var value = '';
            var consumerId = '';
...
//                        alert("Collection Saved Successfully");
    ...
    function AccountHeadDiv() {
        ...
        $('#accountHead' + index).append(' District: <select id="accountHeadDistrictOfficeList' + index + '"><option>Choose A District</option></select> ');
        $.each(districtOfficeArray, function () {
            $('#accountHeadDistrictOfficeList' + index).append('<option>' + (this) + '</option>');
        });
        $('#accountHead' + index).append('&nbsp Treasury Challan Id:<input type="text" size="6"name="accountHeadTreasureId' + index + '" id="accountHeadTreasureId' + index + '" "/>&nbsp&nbsp');
        ...
        $('#accountHead' + index).append('&nbsp&nbsp Establishment Name:<input type="text" readonly="true" size="32" name="accountHeadConsumerName' + index + '" id="accountHeadConsumerName' + index + '" />');
        ...
        $('#accountHead' + index).append('&nbsp&nbsp;Amount in Words(Rs.):<input type="text" size="65" readonly="true" name="accountHeadAmountInWords' + index + '" id="accountHeadAmountInWords' + index + '" "/>&nbsp&nbsp');
        ...
        $('#accountHead' + index).append('&nbsp<input type="button" style="color: red;" id="removeButton' + index + '" value="-" onclick="removeAccountHead(\'' + index + '\')"/>');
    }
