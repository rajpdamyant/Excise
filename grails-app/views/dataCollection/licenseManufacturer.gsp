...
<form id="formID1" >
    <table width="100%">
        ...
        <tr>
            <td colspan="1"><strong>Superintendent Office :&nbsp;${districtOfficeName}</strong></td>  <td colspan="2"><div id=msg style="color:green;float:right;font-weight:bold;padding-right: 55%"></div></td>
        ...
        <tr>
            ...
            <td colspan="2">
                <label>Date:&nbsp;&nbsp;</label><input id="datePickerDate" name="selectedDate"type="text" readonly="true" class="validate[required,custom[selectDate]] text-input">
            </td>
        </tr>
        <tr>
...
<script type="text/javascript">
    ...
    function AccountHeadDiv() {
        ...
        $('#accountHead' + index).append('<div class="treasureLabelDiv"> Treasury Challan Id: </div>' +
                '<div class="treasureInputDiv2"><input type="text" class="validate[required,custom[integer]] text-input" style="width: 130px" name="accountHeadTreasureId" id="accountHeadTreasureId' + index + '" "/></div>');
